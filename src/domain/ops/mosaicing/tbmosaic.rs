...
use crate::domain::{
    ...
    image::Tile,
    ops::{
        mosaicing::{TbMerge, TiePointMatch, TiePointOffset, auto_mosaic::AutoMosaicSearch},
...
/// # Examples
/// ```ignore
/// use viprs::domain::ops::mosaicing::tbmosaic::TbMosaicOp;
///
...
mod tests {
    use super::*;
    use crate::domain::{format::U8, image::Region, op::DynOperation};

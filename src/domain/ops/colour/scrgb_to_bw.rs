...
/// # Examples
/// ```ignore
/// use viprs::domain::ops::colour::scrgb_to_bw::ScRgbToBw;
///
/// let op = ScRgbToBw;
...
mod tests {
    ...
    fn run_process_region(input_data: Vec<f32>) -> Vec<f32> {
        ...
        let input_image =
            crate::domain::image::Image::<F32>::from_buffer(pixels as u32, 1, 3, input_data)
                .unwrap();
    ...
    fn scrgb_to_bw_rejects_underspecified_band_count() {
        ...
        assert!(
            matches!(
                err,
                crate::domain::error::ViprsError::Build(
                    crate::domain::error::BuildError::InvalidOperationBands {
                        op: "ScRgbToBw",
                        input_bands: 2,
                        output_bands: 1,
                        ..

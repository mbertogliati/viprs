...
#[must_use]
pub(crate) const fn flatten_has_alpha(input_bands: u32) -> bool {
    matches!(input_bands, 2 | 4)
}

#[must_use]
pub(crate) const fn flatten_output_bands(input_bands: u32) -> u32 {
...
impl Flatten<crate::domain::format::U8> {
...
impl Flatten<crate::domain::format::F32> {
...
impl Op for Flatten<crate::domain::format::U8> {
    type Input = crate::domain::format::U8;
    type Output = crate::domain::format::U8;
    type State = ();
    ...
    fn process_region(
        &self,
        _state: &mut (),
        input: &Tile<crate::domain::format::U8>,
        output: &mut TileMut<crate::domain::format::U8>,
    ) {
...
impl Op for Flatten<crate::domain::format::F32> {
...
pub(crate) struct FlattenBridge<F: BandFormat> {
    op: Flatten<F>,
    input_bands: u32,
    output_bands: u32,
}

impl FlattenBridge<crate::domain::format::U8> {
    pub fn new(input_bands: u32, background: Vec<u8>) -> Self {
        Self {
            op: Flatten::<crate::domain::format::U8>::new(input_bands, background),
            input_bands,
...
impl FlattenBridge<crate::domain::format::F32> {
    pub fn new(input_bands: u32, background: Vec<f32>) -> Self {
        Self {
            op: Flatten::<crate::domain::format::F32>::new(input_bands, background),
            input_bands,
            output_bands: flatten_output_bands(input_bands),
        }
    }
...
impl DynOperation for FlattenBridge<crate::domain::format::U8> {
    ...
    fn dyn_process_region(
        ...
        let input_tile =
            Tile::<crate::domain::format::U8>::new(input_region, self.input_bands, input_samples);
        let mut output_tile = TileMut::<crate::domain::format::U8>::new(
            output_region,
            self.output_bands,
            output_samples,
        );
...
impl DynOperation for FlattenBridge<crate::domain::format::F32> {
    fn input_format(&self) -> crate::domain::format::BandFormatId {
        crate::domain::format::BandFormatId::F32
    }
    ...
    fn dyn_process_region(
        ...
        let input_tile =
            Tile::<crate::domain::format::F32>::new(input_region, self.input_bands, input_samples);
        let mut output_tile = TileMut::<crate::domain::format::F32>::new(
            output_region,
            self.output_bands,
            output_samples,
        );

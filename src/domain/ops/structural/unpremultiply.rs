...
pub struct Unpremultiply<F: crate::domain::format::BandFormat> {
    bands: u32,
    max_alpha: f64,
    _fmt: PhantomData<F>,
}
...
impl<F: crate::domain::format::BandFormat> Unpremultiply<F> {
...
impl_integer_unpremultiply!(crate::domain::format::U8, u8);
impl_integer_unpremultiply!(crate::domain::format::U16, u16);
impl_integer_unpremultiply!(crate::domain::format::I16, i16);
impl_integer_unpremultiply!(crate::domain::format::U32, u32);
impl_integer_unpremultiply!(crate::domain::format::I32, i32);

impl Op for Unpremultiply<crate::domain::format::F32> {
...
impl PixelLocalOp for Unpremultiply<crate::domain::format::F32> {}

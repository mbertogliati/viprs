...
pub(crate) struct ShrinkVBridge<F: BandFormat>
where
    F::Sample: bytemuck::Pod + ShrinkSample,
{
    inner: crate::domain::op::OperationBridge<ShrinkV<F>>,
}
...
impl<F: BandFormat> crate::domain::op::DynOperation for ShrinkVBridge<F>
where
...
mod tests {
    ...
    use crate::{
        ...
        domain::ops::resample::shrinkh::ShrinkSample,
        domain::{

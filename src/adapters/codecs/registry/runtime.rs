...
use crate::{
    adapters::codecs::{AnalyzeCodec, MatCodec, MatrixCodec, RawCodec},
    domain::{
...
#[cfg(feature = "csv")]
use crate::adapters::codecs::CsvCodec;
...
#[cfg(feature = "fits")]
use crate::adapters::codecs::FitsCodec;
#[cfg(feature = "gif")]
...
#[cfg(feature = "jxl")]
use crate::adapters::codecs::JxlCodec;
#[cfg(feature = "nifti")]
use crate::adapters::codecs::NiftiCodec;
#[cfg(feature = "pdf-poppler")]
use crate::adapters::codecs::PdfPopplerDecoder;
#[cfg(feature = "pfm")]
use crate::adapters::codecs::PfmCodec;
#[cfg(feature = "png")]
use crate::adapters::codecs::PngCodec;
#[cfg(feature = "radiance")]
use crate::adapters::codecs::RadianceCodec;
#[cfg(feature = "svg")]
use crate::adapters::codecs::SvgDecoder;
#[cfg(feature = "tiff")]
use crate::adapters::codecs::TiffCodec;
#[cfg(feature = "uhdr")]
use crate::adapters::codecs::UhdrCodec;
#[cfg(feature = "vips-format")]
use crate::adapters::codecs::VipsCodec;
#[cfg(feature = "webp")]
use crate::adapters::codecs::WebpCodec;
#[cfg(feature = "dcraw")]
use crate::adapters::codecs::{DCRAW_EXTENSIONS, DcrawDecoder};
#[cfg(feature = "magick")]
use crate::adapters::codecs::{MAGICK_FALLBACK_SAVERS, MagickFallbackLoader};
#[cfg(feature = "openslide")]
use crate::adapters::codecs::{OPENSLIDE_EXTENSIONS, OpenSlideDecoder};

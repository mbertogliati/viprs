...
use crate::domain::codec_options::{HeifBitDepth, HeifSubsampling, LoadOptions, SaveOptions};
use crate::domain::error::ViprsError;
use crate::domain::format::{BandFormat, BandFormatId, U8, U16};
use crate::domain::image::{AnimationFrame, FrameDisposal, Image, ImageMetadata};
...
mod tests {
    use super::*;
    use crate::domain::image::ImageMetadata;
    ...
    fn decode_with_multi_page_request_returns_animation_frames() {
        ...
        assert_eq!(
            frames[0].disposal(),
            crate::domain::image::FrameDisposal::Keep
        );
        assert_eq!(
            frames[1].disposal(),
            crate::domain::image::FrameDisposal::Keep

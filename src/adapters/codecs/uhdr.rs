...
use crate::adapters::codecs::jpeg::{extract_exif_orientation, orient_u8_image};
...
use crate::domain::image::{Image, UhdrGainMap};
use crate::domain::ops::colour::UhdrGainMapMetadata;
...
mod tests {
    ...
    use crate::adapters::codecs::registry::ForeignRegistry;

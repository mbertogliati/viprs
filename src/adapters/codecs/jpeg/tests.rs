...
const METRICS_CHILD_TEST: &str =
    "adapters::codecs::jpeg::tests::shrink_on_load_decode_metrics_child";
const RSS_PREFIX: &str = "VIPRS_JPEG_ERROR_RSS";
const RSS_CHILD_ENV: &str = "VIPRS_JPEG_ERROR_RSS_CHILD";
const RSS_CHILD_TEST: &str =
    "adapters::codecs::jpeg::tests::repeated_truncated_decode_errors_keep_rss_stable_child";
...
fn decode_sets_srgb_interpretation_for_rgb_jpeg() {
    ...
    let decoded = codec.decode::<crate::domain::format::U8>(&encoded).unwrap();

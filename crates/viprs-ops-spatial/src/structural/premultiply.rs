...
impl_integer_premultiply!(viprs_core::format::U8, u8);
impl_integer_premultiply!(viprs_core::format::U16, u16);
impl_integer_premultiply!(viprs_core::format::I16, i16);
impl_integer_premultiply!(viprs_core::format::U32, u32);
impl_integer_premultiply!(viprs_core::format::I32, i32);

impl Op for Premultiply<viprs_core::format::F32> {
...
impl Op for Premultiply<viprs_core::format::F64> {
    type Input = viprs_core::format::F64;
    type Output = viprs_core::format::F64;
    type State = ();
    ...
    fn process_region(
        &self,
        _state: &mut (),
        input: &Tile<viprs_core::format::F64>,
        output: &mut TileMut<viprs_core::format::F64>,
    ) {
        let bands = self.bands as usize;
        debug_assert!(bands >= 2, "premultiply requires at least 2 bands");
        debug_assert!(
...
impl PixelLocalOp for Premultiply<viprs_core::format::F32> {}
impl PixelLocalOp for Premultiply<viprs_core::format::F64> {}

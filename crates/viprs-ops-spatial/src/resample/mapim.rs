    ...
    F::Sample: Pod + ToF64 + FromF64 + Send,
{
    ...
    fn coordinate_driven_source_spec(&self) -> Option<viprs_core::op::CoordinateDrivenSourceSpec> {
        Some(viprs_core::op::CoordinateDrivenSourceSpec {
            source_slot: 0,
            dependency_slot: 1,
        })
    }
    ...
    fn node_spec_sizes_full_image_sources() {
        ...
        assert_eq!(
            ...
            NodeSpec {
                ...
                output_tile_w: 32,
                output_tile_h: 16,
                coordinate_driven_source: Some(viprs_core::op::CoordinateDrivenSourceSpec {
                    source_slot: 0,
                    dependency_slot: 1,
                }),
            }

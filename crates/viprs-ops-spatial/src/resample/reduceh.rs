...
pub struct ReduceHBridge<F: BandFormat>
where
    F::Sample: bytemuck::Pod + ReduceSample,
{
    inner: viprs_core::op::OperationBridge<ReduceH<F>>,
...
impl<F: BandFormat> viprs_core::op::DynOperation for ReduceHBridge<F>
where
...
mod tests {
    use super::*;
    use crate::resample::{reduce_simd, shrinkh::ShrinkH};

...
pub trait ShrinkSample: Copy + 'static {
    fn to_f64(self) -> f64;
...
pub struct ShrinkHBridge<F: BandFormat>
where
    F::Sample: bytemuck::Pod + ShrinkSample,
{
    inner: viprs_core::op::OperationBridge<ShrinkH<F>>,
}
    ...
    F::Sample: bytemuck::Pod + ShrinkSample,
{
    ...
    pub fn new_with_ceil_and_source_width(
        ...
        Ok(Self {
            inner: viprs_core::op::OperationBridge::new(op, bands),
        })
    }
}

impl<F: BandFormat> viprs_core::op::DynOperation for ShrinkHBridge<F>
where

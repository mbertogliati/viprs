...
mod tests {
    ...
    use viprs_core::format::{F32, I16, U8, U16, U32};
    ...
    fn vertical_i32_histograms_offset_negative_values_before_thresholding() {
        ...
        let op =
            HistPlotOp::<viprs_core::format::I32>::from_histogram(1, 2, 1, &histogram).unwrap();
    ...
    fn hist_plot_rejects_zero_band_histograms() {
        ...
        assert!(
            matches!(
                err,
                viprs_core::error::ViprsError::Scheduler(ref message)

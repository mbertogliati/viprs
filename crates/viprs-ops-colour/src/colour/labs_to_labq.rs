...
/// # Examples
/// ```ignore
/// use viprs::domain::crate::colour::labs_to_labq::LabSToLabQ;
///
/// let op = LabSToLabQ;
...
mod tests {
    use super::*;
    use crate::colour::labq_to_labs::LabQToLabS;
    ...
    fn half_step_rounding_moves_away_from_zero_for_labs_quantization() {
        let input_image =
            viprs_core::image::Image::<I16>::from_buffer(1, 1, 3, vec![16, 16, -16]).unwrap();
        let region = make_region(1);

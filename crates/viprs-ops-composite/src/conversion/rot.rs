    ...
    F::Sample: Copy,
{
    ...
    fn required_input_region(&self, output: &Region) -> Region {
        match self.angle {
            Angle::D0 => *output,
            Angle::D90 => viprs_ops_spatial::structural::rotate90::Rotate90::<F>::new(
                self.image_width,
                self.image_height,
            )
            .required_input_region(output),
            Angle::D180 => viprs_ops_spatial::structural::rotate180::Rotate180::<F>::new(
                self.image_width,
                self.image_height,
            )
            .required_input_region(output),
            Angle::D270 => viprs_ops_spatial::structural::rotate270::Rotate270::<F>::new(
                self.image_width,
                self.image_height,
            )
            .required_input_region(output),
    ...
    fn process_region(&self, state: &mut (), input: &Tile<F>, output: &mut TileMut<F>) {
        match self.angle {
            ...
            Angle::D90 => {
                viprs_ops_spatial::structural::rotate90::Rotate90::<F>::new(
                    self.image_width,
                    self.image_height,
                )
            ...
            Angle::D180 => {
                viprs_ops_spatial::structural::rotate180::Rotate180::<F>::new(
                    self.image_width,
                    self.image_height,
                )
                .process_region(state, input, output);
            ...
            Angle::D270 => {
                viprs_ops_spatial::structural::rotate270::Rotate270::<F>::new(
                    self.image_width,
                    self.image_height,
                )
                .process_region(state, input, output);
...
pub struct RotBridge<F: BandFormat>
where

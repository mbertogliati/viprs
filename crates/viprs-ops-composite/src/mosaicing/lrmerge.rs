...
use crate::mosaicing::merge::MergeH;
...
mod tests {
    ...
    fn dyn_contract_delegates() {
        ...
        assert_eq!(op.input_format(), viprs_core::format::BandFormatId::U8);
        assert_eq!(op.output_format(), viprs_core::format::BandFormatId::U8);

...
fn bench_round(c: &mut Criterion) {
    let mut group = c.benchmark_group("round_f32");
...
fn bench_floor(c: &mut Criterion) {
    let mut group = c.benchmark_group("floor_f32");
...
fn bench_ceil(c: &mut Criterion) {
    let mut group = c.benchmark_group("ceil_f32");
...
criterion_group!(benches, bench_round, bench_floor, bench_ceil);

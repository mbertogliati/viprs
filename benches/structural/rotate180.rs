...
/// RayonScheduler. The operation reverses both axes while preserving image size.
...
fn bench_rotate180(c: &mut Criterion) {
    let mut group = c.benchmark_group("rotate180_u8");
...
criterion_group!(benches, bench_rotate180);

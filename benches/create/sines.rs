...
use viprs::{
    ...
    domain::{format::F32, op::OperationBridge, ops::create::SinesOp},
    ports::scheduler::TileScheduler,
};

fn bench_sines(c: &mut Criterion) {
    let mut group = c.benchmark_group("create_sines_f32");
...
criterion_group!(benches, bench_sines);

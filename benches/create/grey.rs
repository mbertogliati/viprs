...
use viprs::{
    ...
    domain::{format::F32, op::OperationBridge, ops::create::GreyOp},
    ports::scheduler::TileScheduler,
};

fn bench_grey(c: &mut Criterion) {
    let mut group = c.benchmark_group("create_grey_f32");
...
criterion_group!(benches, bench_grey);
